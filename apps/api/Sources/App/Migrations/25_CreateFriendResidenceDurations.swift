...
struct CreateFriendResidenceDurations: AsyncMigration {
  ...
  func prepare(on database: Database) async throws {
    get(dependency: \.logger).info("Running migration: CreateFriendResidenceDurations UP")
  ...
  func revert(on database: Database) async throws {
    get(dependency: \.logger).info("Running migration: CreateFriendResidenceDurations DOWN")
