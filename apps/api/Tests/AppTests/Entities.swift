...
struct Entities {
  ...
  static func create(
    ...
    _ = try! await db.create(entities.friend)
    _ = try! await db.create(entities.friendQuote)
    _ = try! await db.create(entities.friendResidence)
    _ = try! await db.create(entities.friendResidenceDuration)
    _ = try! await db.create(entities.document)
    _ = try! await db.create(entities.documentTag)
    _ = try! await db.create(entities.edition)
    _ = try! await db.create(entities.editionChapter)
    _ = try! await db.create(entities.editionImpression)
    _ = try! await db.create(entities.isbn)
    _ = try! await db.create(entities.audio)
    _ = try! await db.create(entities.audioPart)
