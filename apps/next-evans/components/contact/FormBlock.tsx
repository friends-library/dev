      ...
      <div className="flex flex-col lg:flex-row lg:py-24 lg:px-6 max-w-screen-lg mx-auto">
        <div className="bg-white p-16 text-center lg:text-left body-text flex flex-col lg:w-1/3 lg:bg-flgray-100 lg:px-12">
          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            <Dual.P key="p1">
              <>
                Got a question? &mdash; or are you having any sort of technical trouble
                with our books or website?
              </>
              <>
            ...
            <Dual.P key="p3">
              <>
                We’d love to hear from you! You can expect to hear back within a day or
                two.
              </>
              <>
                ¡Nos encantaría escucharte! Puedes contar con nuestra respuesta en un día
                o dos.
              </>
            </Dual.P>
          </div>
        ...
        <Form
          onSubmit={onSubmit}
          className="lg:flex-grow p-6 m-2 sm:m-6 lg:m-0 lg:py-12"
        />
      </div>
    </div>
  </BackgroundImage>
