...
const GettingStarted: React.FC<Props> = ({ numBooks }) => {
  return (
    <div>
      <BackgroundImage src={BooksGrid} className="" fit={'cover'} position={'center'}>
        <div className="flex flex-col items-center justify-center p-36 [background:radial-gradient(rgb(0_0_0/0.65),rgb(0_0_0/0.85),rgb(0_0_0/0.95))]">
          ...
          <Dual.P className="text-center body-text text-white text-lg leading-loose max-w-4xl md:text-left">
            <>
              Interested in reading something from the early Quakers, but picking from 7
              books seems daunting? No worries&mdash;on this page we’ve selected some of
              our favorite books and arranged them into four categories. Plus we’ve got an
              introductory audio to help introduce you to the early Friends.
            </>
            <>
              ¿Estás interesado en leer algo de los primeros Cuáqueros, pero no estás
              seguro de dónde empezar? ¡No hay problema! En esta página hemos seleccionado
              algunos de nuestros libros favoritos y los hemos organizado en categorías
              para ayudarte a decidir. Además, hemos puesto un audio introductorio para
              ayudarte a conocer quienes fueron los primeros Amigos.
            </>
          </Dual.P>
        </div>
      </BackgroundImage>
