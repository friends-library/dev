...
const NotFoundHeroBlock: React.FC = () => (
  <BackgroundImage
    src={SheepBg}
    fit="cover"
    position="[object-position:center_80%]"
    className="text-center text-white"
  >
    <div className="bg-black/40 px-10 py-20 sm:px-16 sm:py-24 md:py-24 xl:py-32">
      ...
      <Dual.P className="body-text text-white py-8 text-lg leading-loose max-w-screen-sm mx-auto">
        ...
        <>
          ...
          contactarnos si crees que has encontrado un problema con el sitio web &mdash;
          ¡Nos encantaría saberlo para poder solucionarlo lo antes posible!!
        </>
      </Dual.P>
      <form
        action="https://google.com/search"
        className="flex flex-col md:flex-row p-3 sm:p-8 max-w-screen-md rounded-md mx-auto bg-black/50"
      >
        <input
          type="hidden"
          name="sitesearch"
