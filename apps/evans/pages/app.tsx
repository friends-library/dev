    ...
    <div className="p-10 flex flex-col items-center md:py-16">
      ...
      <Dual.P className="body-text pb-12 max-w-screen-md leading-loose">
        <>
          ...
          with more being added regularly. Unfortunately, downloading and listening to our
          audiobooks <em>directly from this website</em> is quite difficult, even for
          knowledgeable users. The Friends Library App makes it super easy to download and
          listen to any of our audiobooks, wherever you are. Just select an audiobook from
          the list and press play. You can download entire audiobooks while you&rsquo;re
          connected to Wifi and listen to them conveniently later when you may or may not
          have internet.
        </>
        <>
      ...
      <Dual.P className="body-text pb-12 max-w-screen-md leading-loose">
        <>
          Every single one of our {numBooks} books can be conveniently read in electronic
          form, from right within the Friends Library app. The built in e-reader allows
          customization of the color scheme and font size, and will keep your position in
          as many books as you&rsquo;re reading, allowing you to easily pick up where you
          left off. Plus, every new book we add, and every error we fix in any of our
          published texts will automatically be downloaded and synced in your app, so
          you&rsquo;ll always be up to date.
        </>
        <>
          ...
          corrijamos en alguno de nuestros textos publicados, se descargará y sincronizará
